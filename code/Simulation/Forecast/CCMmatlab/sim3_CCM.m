%In this script, we combine the Matlab code from Carriero, Clark and Marcellino (2017) %
% (publicly available at  http://didattica.unibocconi.eu/mypage/index.php?IdUte=49257&idr=27515&lingua=eng) %
% with Matlab code for BVAR using Gibbs sampling available at %
...
MSFEs_CCM_sim3_p4 = zeros(Nsim, 1); % Mean Squared Forecast Errors CCM
...
Yraw = sim3(((n)*(isim-1)+1):(isim*n), 1:end);
...
MSFEs_CCM_sim3_p4(isim,1) = MSFE;

end
mean(MSFEs_CCM_sim3_p4)
