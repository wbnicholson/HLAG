...
mediumlargeset <- c(which(colnames(data)=="GDPC1"),
                    ...
                    which(colnames(data)=="UNRATE"),
                    which(colnames(data)=="HOUST"),
                    which(colnames(data)=="WPSFD49207"),
                    which(colnames(data)=="PCECTPI"),
                    which(colnames(data)=="COMPRNFB"),
                    which(colnames(data)=="M1REAL"),
                    which(colnames(data)=="S.P..indust"),
                    which(colnames(data)=="GS10"),
                    which(colnames(data)=="EXUSUKx"),
                    which(colnames(data)=="PAYEMS"),
                    
                    which(colnames(data)=="GS10TB3Mx"),
                    which(colnames(data)=="TLBSNNCBx"),
                    which(colnames(data)=="RSAFSx"),
                    which(colnames(data)=="AMDMNOx"),
                    which(colnames(data)=="PPICMM"),
                    which(colnames(data)=="Y033RC1Q027SBEAx"),
                    which(colnames(data)=="BUSINVx"),
                    which(colnames(data)=="CES0600000008"),
                    which(colnames(data)=="EXPGSC1"),
                    which(colnames(data)=="IMPGSC1"),
                    which(colnames(data)=="GCEC1"),
                    which(colnames(data)=="HOANBS"),
                    which(colnames(data)=="TLBSHNOx"),
                    which(colnames(data)=="TOTALSLx"),
                    which(colnames(data)=="BUSLOANSx"),
                    which(colnames(data)=="IPMANSICS"),
                    which(colnames(data)=="HOUST5F"),
                    which(colnames(data)=="GPDIC1"),
                    which(colnames(data)=="PCDGx"),
                    which(colnames(data)=="HWIx"))
FREDmediumlarge <- data[, mediumlargeset]
...
MSFEs_others_array <- array(NA, c(76, ncol(Ymediumlarge), 4))
for(it in 1:76){
